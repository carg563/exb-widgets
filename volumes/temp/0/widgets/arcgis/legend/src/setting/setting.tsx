...
import {Switch, Radio, Label, BackgroundStyle, FillType} from 'jimu-ui';
        ...
        */}
          ...
          <SettingSection>
            <SettingRow className="advanced-setting-row" label={<FormattedMessage id="advance" defaultMessage={'Advanced'}/>}>
              <Switch className="can-x-switch" checked={this.getStyleConfig().useCustom || false}
            ...
            <div className="mt-3" style={{display: displayStyleContent}}>
              <SettingRow label={<FormattedMessage id="font" defaultMessage={'Font'}/>}>
                <ThemeColorPicker pickerBlockProps={pickerBlockProps} specificTheme={this.props.appTheme}
                  value={this.getStyleConfig().fontColor || this.props.appTheme.arcgis.widgets.legend.variants?.default?.root?.color || ''} onChange={this.onFontStyleChanged}></ThemeColorPicker>
              </SettingRow>
              <SettingRow label={<FormattedMessage id="background" defaultMessage={'Background'}/>}>
                ...
                <ThemeColorPicker specificTheme={this.props.appTheme} value={this.getStyleConfig().background?.color || this.props.appTheme.surfaces[1].bg || ''}
